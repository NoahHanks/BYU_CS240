...
public class Database {
    ...
    public Connection openConnection() throws DataAccessException {
        try {
            ...
            final String CONNECTION_URL = "jdbc:sqlite:MyDatabase.sqlite";
    ...
    /**
     * Clears the users, authtoken, event, and person tables in the database
     *
     * @throws DataAccessException if error occurs while clearing the tables in the database
     */
