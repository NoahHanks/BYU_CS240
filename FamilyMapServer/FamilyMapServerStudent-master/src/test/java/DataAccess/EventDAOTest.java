...
public class EventDAOTest {
    ...
    @Test
    @DisplayName("Insert Event Test Positive")
    ...
    @Test
    @DisplayName("Insert Event Test Negative")
    ...
    @Test
    @DisplayName("Find Event Test Positive")
    public void findPass() throws DataAccessException {
        eDao.insert(bestEvent);
        Event test = eDao.find(bestEvent.getEventID());
        assertEquals(bestEvent, test);
    }

    @Test
    @DisplayName("Find Event Test Negative")
