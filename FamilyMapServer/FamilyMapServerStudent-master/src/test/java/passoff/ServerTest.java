...
public class ServerTest {
     ...
     *
     * @param eventsResult A EventResult holding an empty Event List and an error message
     */
     ...
     * empty. Ends by verifying that an error was reported.
     *
     * @param personsResult A PersonResult holding an empty Person List and an error message
     */
     ...
     * empty. Ends by verifying that an error was reported.
     *
     * @param eventResult An EventIDResult holding an empty Event and an error message
     */
